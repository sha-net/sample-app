...
case "$1" in
        start)
            sed -i "s/TEMPLATE_APP-NAME/$TEMPLATE_APP_NAME/g" $YAML_FILE
            sed -i "s/TEMPLATE_APP-PORT/$TEMPLATE_APP_PORT/g" $YAML_FILE
            sed -i "s/TEMPLATE_IMAGE/$TEMPLATE_IMAGE/g" $YAML_FILE
