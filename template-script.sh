...
case "$1" in
        start)
            sed -i "s/TEMPLATE_APP-NAME/$TEMPLATE-APP-NAME/g" $YAML_FILE
            sed -i "s/TEMPLATE_APP-PORT/$TEMPLATE-APP-PORT/g" $YAML_FILE
            sed -i "s/TEMPLATE_IMAGE/$TEMPLATE-IMAGE/g" $YAML_FILE
